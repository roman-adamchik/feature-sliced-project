...
export const EditableProfileCard = (props: EditableProfileCardProps) => {
  ...
  const validationErrorsMap = useMemo(
    () => ({
      ...
      [ProfileValidationErrors.INCORRECT_USER_AVATAR]: t(
        'Incorrect avatar link',
      ),
